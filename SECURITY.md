...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/mustfile/security/advisories/new)
...
- This repository (`hyperpolymath/mustfile`) and all its code
...
- We consider your research authorised under applicable computer crime laws
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/mustfile/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/mustfile/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/mustfile/security/advisories/new) or hyperpolymath@proton.me |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/mustfile/discussions) |
...
*Thank you for helping keep Must and its users safe.*
