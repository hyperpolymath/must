pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__must.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__must.adb");
...
package body ada_main is
   ...
   E186 : Short_Integer; pragma Import (Ada, E186, "ada__calendar_E");
   ...
   E184 : Short_Integer; pragma Import (Ada, E184, "ada__directories_E");
   E161 : Short_Integer; pragma Import (Ada, E161, "must_types_E");
   E155 : Short_Integer; pragma Import (Ada, E155, "cli_parser_E");
   E182 : Short_Integer; pragma Import (Ada, E182, "deployer_E");
   E214 : Short_Integer; pragma Import (Ada, E214, "mustache_engine_E");
   E220 : Short_Integer; pragma Import (Ada, E220, "requirement_checker_E");
   E222 : Short_Integer; pragma Import (Ada, E222, "task_runner_E");
   E218 : Short_Integer; pragma Import (Ada, E218, "toml_parser_E");
   E216 : Short_Integer; pragma Import (Ada, E216, "mustfile_loader_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "toml_parser__finalize_spec");
      begin
         F1;
      end;
      E220 := E220 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "requirement_checker__finalize_spec");
      begin
         F2;
      end;
      E161 := E161 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "must_types__finalize_spec");
      begin
         F3;
      end;
      declare
   ...
   begin
      ...
      E184 := E184 + 1;
      Must_Types'Elab_Spec;
      E161 := E161 + 1;
      Cli_Parser'Elab_Spec;
      E155 := E155 + 1;
      Deployer'Elab_Spec;
      E182 := E182 + 1;
      Mustache_Engine'Elab_Spec;
      E214 := E214 + 1;
      Requirement_Checker'Elab_Spec;
      E220 := E220 + 1;
      Task_Runner'Elab_Spec;
      E222 := E222 + 1;
      Toml_Parser'Elab_Spec;
      Toml_Parser'Elab_Body;
      E218 := E218 + 1;
      Mustfile_Loader'Elab_Spec;
      E216 := E216 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_must");
...
--  BEGIN Object file/option list
   --   /var/mnt/eclipse/repos/must/obj/must_types.o
   --   /var/mnt/eclipse/repos/must/obj/cli_parser.o
   --   /var/mnt/eclipse/repos/must/obj/deployer.o
   --   /var/mnt/eclipse/repos/must/obj/mustache_engine.o
   --   /var/mnt/eclipse/repos/must/obj/requirement_checker.o
   --   /var/mnt/eclipse/repos/must/obj/task_runner.o
   --   /var/mnt/eclipse/repos/must/obj/toml_parser.o
   --   /var/mnt/eclipse/repos/must/obj/mustfile_loader.o
   --   /var/mnt/eclipse/repos/must/obj/must.o
   --   -L/var/mnt/eclipse/repos/must/obj/
   --   -L/var/mnt/eclipse/repos/must/obj/
